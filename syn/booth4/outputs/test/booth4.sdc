...
# Created by write_sdc on Fri May 13 11:53:45 2022
...
set_load -pin_load 0.05 [get_ports io_cal_finish]
...
group_path -name INPUT_GROUP  -from [list [get_ports io_din_vld] [get_ports {io_dinA[7]}] [get_ports        \
{io_dinA[6]}] [get_ports {io_dinA[5]}] [get_ports {io_dinA[4]}] [get_ports     \
{io_dinA[3]}] [get_ports {io_dinA[2]}] [get_ports {io_dinA[1]}] [get_ports     \
{io_dinA[0]}] [get_ports {io_dinB[7]}] [get_ports {io_dinB[6]}] [get_ports     \
{io_dinB[5]}] [get_ports {io_dinB[4]}] [get_ports {io_dinB[3]}] [get_ports     \
{io_dinB[2]}] [get_ports {io_dinB[1]}] [get_ports {io_dinB[0]}] [get_ports     \
clk] [get_ports resetn]]
group_path -name OUTPUT_GROUP  -to [list [get_ports io_dout_vld] [get_ports io_cal_finish] [get_ports        \
{io_dout[15]}] [get_ports {io_dout[14]}] [get_ports {io_dout[13]}] [get_ports  \
{io_dout[12]}] [get_ports {io_dout[11]}] [get_ports {io_dout[10]}] [get_ports  \
{io_dout[9]}] [get_ports {io_dout[8]}] [get_ports {io_dout[7]}] [get_ports     \
{io_dout[6]}] [get_ports {io_dout[5]}] [get_ports {io_dout[4]}] [get_ports     \
{io_dout[3]}] [get_ports {io_dout[2]}] [get_ports {io_dout[1]}] [get_ports     \
{io_dout[0]}]]
...
set_output_delay -clock clk  6  [get_ports io_cal_finish]
...
set_clock_gating_check -rise -setup 0.3 [get_cells clk_gate_shiftReg_reg/latch]
set_clock_gating_check -fall -setup 0.3 [get_cells clk_gate_shiftReg_reg/latch]
set_clock_gating_check -rise -hold 0 [get_cells clk_gate_shiftReg_reg/latch]
set_clock_gating_check -fall -hold 0 [get_cells clk_gate_shiftReg_reg/latch]
set_clock_gating_check -rise -setup 0.3 [get_cells clk_gate_Breg_reg/latch]
set_clock_gating_check -fall -setup 0.3 [get_cells clk_gate_Breg_reg/latch]
set_clock_gating_check -rise -hold 0 [get_cells clk_gate_Breg_reg/latch]
set_clock_gating_check -fall -hold 0 [get_cells clk_gate_Breg_reg/latch]
