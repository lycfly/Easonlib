...
# Created by write_sdc on Thu Dec 16 23:55:46 2021
...
group_path -name OUTPUT_GROUP  -to [list [get_ports io_dout_vld] [get_ports {io_dout[15]}] [get_ports        \
...
{io_dout[2]}] [get_ports {io_dout[1]}] [get_ports {io_dout[0]}]]
...
set_clock_gating_check -rise -setup 0.3 [get_cells clk_gate_cal_cnt_reg/latch]
set_clock_gating_check -fall -setup 0.3 [get_cells clk_gate_cal_cnt_reg/latch]
set_clock_gating_check -rise -hold 0 [get_cells clk_gate_cal_cnt_reg/latch]
set_clock_gating_check -fall -hold 0 [get_cells clk_gate_cal_cnt_reg/latch]
