...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/mnt/data/projects/kws/Easonlib/./simWorkspace/booth4/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/mnt/data/projects/kws/Easonlib/./simWorkspace/booth4/") + name + ".dat").c_str());
      #endif
    }
