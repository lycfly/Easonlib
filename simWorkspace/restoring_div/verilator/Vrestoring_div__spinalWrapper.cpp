...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.din_vld );
      signalAccess[1] = new CDataSignalAccess( top.dinA );
      signalAccess[2] = new CDataSignalAccess( top.dinB );
      signalAccess[3] = new CDataSignalAccess( top.dout_vld );
      signalAccess[4] = new SDataSignalAccess( top.quot );
      signalAccess[5] = new CDataSignalAccess( top.remainder );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lyc/project/Easonlib/./simWorkspace/restoring_div/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lyc/project/Easonlib/./simWorkspace/restoring_div/") + name + ".dat").c_str());
      #endif
    }
