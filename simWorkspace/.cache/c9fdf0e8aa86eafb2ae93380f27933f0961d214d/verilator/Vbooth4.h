...
VL_MODULE(Vbooth4) {
  public:
    ...
    CData/*4:0*/ booth4__DOT__Breg;
    CData/*6:0*/ booth4__DOT__PositiveB;
    CData/*6:0*/ booth4__DOT__AddB;
    CData/*6:0*/ booth4__DOT__MinusB;
    CData/*0:0*/ booth4__DOT__cal_cnt;
    ...
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ __Vdly__booth4__DOT__cal_cnt;
