...
VL_MODULE(Vbooth4) {
  public:
    ...
    VL_IN16(io_dinA,15,0);
    VL_IN16(io_dinB,15,0);
    VL_OUT(io_dout,31,0);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    CData/*2:0*/ booth4__DOT__cal_cnt;
    CData/*0:0*/ booth4__DOT__cal_en;
    CData/*0:0*/ booth4__DOT__cal_en_regNext;
    SData/*15:0*/ booth4__DOT__Breg;
    IData/*17:0*/ booth4__DOT__PositiveB;
    IData/*17:0*/ booth4__DOT__AddB;
    IData/*17:0*/ booth4__DOT__MinusB;
    QData/*34:0*/ booth4__DOT___zz_aftershift_1;
    QData/*34:0*/ booth4__DOT__shiftReg;
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*2:0*/ __Vdly__booth4__DOT__cal_cnt;
