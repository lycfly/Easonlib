...
VL_MODULE(Vbooth4) {
  public:
    ...
    VL_OUT16(io_dout,11,0);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    CData/*5:0*/ booth4__DOT__Breg;
    CData/*7:0*/ booth4__DOT__PositiveB;
    ...
    SData/*14:0*/ booth4__DOT___zz_aftershift_1;
    SData/*14:0*/ booth4__DOT__shiftReg;
